...
# Histigram of each defensive statistic facet wrapped together. The bins (value) represent how many times a statistic was recorded. Count represent number of players. 
```
...
# Scatterplot of the number of solo tackles by each ISU player between West Virginia and Kansas State. 
```
...
# Bar graph of the number of ISU players' per hometown state.
```
